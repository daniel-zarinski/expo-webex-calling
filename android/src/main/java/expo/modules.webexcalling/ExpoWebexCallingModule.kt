package expo.modules.webexcalling

import expo.modules.kotlin.modules.Module
import expo.modules.kotlin.modules.ModuleDefinition

class ExpoWebexCallingModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    ...
    // The module will be accessible from `requireNativeModule('ExpoWebexCalling')` in JavaScript.
    ...
    ViewManager {
      ...
      View { context -> 
        ExpoWebexCallingView(context) 
      }

      // Defines a setter for the `name` prop.
      Prop("name") { view: ExpoWebexCallingView, prop: String ->
        println(prop)
      }
    }
  }
